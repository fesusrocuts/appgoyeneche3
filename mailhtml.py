...
def sendmailhtml(sender_email, receiver_email, Subject, text, html):
    ...
    mserver="mail.s415.sureserver.com"
    mport=465
    password = "3175141592"
    sender_email="logistica@comercializadoragyl.com"
    #receiver_email="frocuts1982@gmail.com"
    bcc=""
    print("sendmail...")
    ...
    with smtplib.SMTP_SSL(mserver, mport, context=context) as server:
...
receiver_email = "fesusrocuts@gmail.com"
